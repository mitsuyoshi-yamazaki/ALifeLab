  ...
  return (
    <div>
      ...
      <div style={bodyStyle}>
        ...
        <LinkCard title="Meta Generative Art v5" link="pages/meta_generative_art_v5.html?s=600&o=100&a=1&fr=0.5&fs=0.1&ff=0.999&fa=200&d.d=0&d.f=0.1&d.c=1&d.fi=0.5" />
