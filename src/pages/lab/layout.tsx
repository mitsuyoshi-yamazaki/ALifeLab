  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <div style={bodyStyle}>
        ...
        <LinkCard title="線と角度: パラメータの変更" link="drawer_change_parameter.html?simulation.lsystem_rule=A:-88,A,-152,A&simulation.parameter_changes=5,-5&simulation.parameter_period=720&system.auto_download=0" />
