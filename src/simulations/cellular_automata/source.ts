...
import { HydrophilicRule } from "./rules/hydrophilic_rule"
...
function createHydrophilicRule(): Rule {
  return new HydrophilicRule(constants.simulation.radius)
}
