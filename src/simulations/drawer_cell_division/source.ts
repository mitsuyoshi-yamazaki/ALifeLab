...
import { exampleRules, Rule } from "./rule_examples"
import { CellDivisionModel } from "./cell_division_model"

let t = 0
const canvasId = "canvas"
const fieldSize = constants.system.fieldSize
const firstRules: Rule[] = constants.system.run ? [] :
  (constants.simulation.lSystemRule.length > 0 ? [{ initialState: "A", rule: constants.simulation.lSystemRule }] : exampleRules)
...
function createModel(rules: Rule[]): Model {
