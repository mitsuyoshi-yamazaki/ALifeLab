...
import { CodableRuleInfo, encodeRules } from "../../../src/simulations/la_interactive/rule_url_parameter_encoder"
...
describe("Encode", () => {
  test("", () => {
    expect(encodeRules([decodedRuleInfo1])).toBe(encodedRuleInfo1)
  })

  test("", () => {
    expect(encodeRules([decodedRuleInfo1, decodedRuleInfo2])).toBe(`${encodedRuleInfo1};;${encodedRuleInfo2}`)
  })
})
